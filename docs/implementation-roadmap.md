...
仕様書の分析 → プロジェクトセットアップ → MVP開発 → 完全ルール → 拡張機能 → 最適化
    ✓              Issue #1           Phase 1    Phase 2     Phase 3     Phase 4
                                    (2-3週間)   (1-2週間)    (1週間)     (1週間)
```
...
Week 4: こいこいと特殊ルール
┌──────────────┐  ┌──────────────┐  ┌──────────────┐
│ Issue #13    │  │ Issue #14    │  │ Issue #15    │  並行開発可能
│ こいこい      │  │ 喰い付き      │  │ 猪鹿蝶等     │
│              │  │              │  │ 花見・月見    │
└──────────────┘  └──────────────┘  └──────────────┘

┌──────────────┐  ┌──────────────┐  ┌──────────────┐
│ Issue #16    │  │ Issue #17    │  │ Issue #18    │  並行開発可能
│ 赤短・青短    │  │ 総流れ        │  │ 再配札       │
└──────────────┘  └──────────────┘  └──────────────┘
                                          │
                                          v
...
Week 6: 最適化と仕上げ
┌──────────────┐  ┌──────────────┐  ┌──────────────┐
│ Issue #24    │  │ Issue #25    │  │ Issue #26    │  並行開発可能
│ パフォーマンス │  │ 詳細ログ      │  │ リプレイ     │
│ 最適化       │  │ 機能         │  │ 機能         │
└──────────────┘  └──────────────┘  └──────────────┘
                                          │
...
```
┌──────────────┐
│ Issue #30    │  CI/CD設定 - プロジェクト初期から並行実装推奨
└──────────────┘

┌──────────────┐
│ Issue #28    │  エラーハンドリング - フェーズ2で実装
└──────────────┘

┌──────────────┐
│ Issue #29    │  APIドキュメント - フェーズ4で実装
└──────────────┘
```
